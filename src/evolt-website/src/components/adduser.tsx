...
export default function AddUserModal() {
    ...
    return (
        <>
            <button type="button" onClick={openModal} className="flex items-center p-2.5 ms-2 me-5 text-sm font-medium text-white bg-pallete-4 rounded-lg border px-2 py-1">
